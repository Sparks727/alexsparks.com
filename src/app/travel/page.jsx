...
export const metadata = {
  title: 'Travel',
  description: 'Places I have traveled to',
}

export default function Travel() {
  return (
    <SimpleLayout
      title="Places I have traveled to"
      intro="Visting every state within The United States has always been a dream for me! Check out my progress below."
    >
