    ...
    <div className="space-y-4">
      <div className="text-center">
        <div className="text-lg font-semibold text-zinc-800 dark:text-zinc-100 mb-2">
          Score: {score} {isPaused && <span className="text-yellow-500">(Paused)</span>}
        </div>
        {gameOver && (
...
export default function GamesClient() {
  return (
    <SimpleLayout
      title="Snake Game"
      intro="Classic Snake game built with React and Next.js. Use WASD keys to control the snake and eat food to grow!"
    >
      <div className="rounded-2xl border border-zinc-100 p-8 dark:border-zinc-700/40 bg-white dark:bg-zinc-800/50">
        <SnakeGame />
      </div>
    </SimpleLayout>
  )
