...
export const article = {
  ...
  description:
    'Struggling to rank on Google Maps? In this article I share my tips on choosing the optimal location for your Google Business Profile to maximize visibility and attract local customers.',
}
